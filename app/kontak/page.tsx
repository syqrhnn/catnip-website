              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-4 group">
                    <div className="w-12 h-12 bg-[#FDF0E8] text-[#CC5500] rounded-full flex shrink-0 items-center justify-center transition-all duration-200 group-hover:bg-[#CC5500] group-hover:text-white">
                      {item.icon}
                    </div>
                    <div>
                      <h3 className="font-bold text-lg">{item.title}</h3>
                      <p className="text-sm mt-1 leading-relaxed" style={{ color: "#525252" }}>{item.text}</p>
                    </div>
                  </div>
                ))}
              </div>
